...
if __name__ == "__main__":
    ...
    ####################### TASK 3: Using the HTTP API with Python #######################

    # Task 3a: Query a sample metric from Prometheus.
    ...
    # Task 3b: Count the number of pods in the "open5gs" namespace.
    ...
    ####################### TASK 4: Retrieve VNFM Metrics ###########################

    # Task 4a: Identify the node where "UPF1" pod is deployed.
    ...
    # Task 4b: Check the CPU limit set for the "UPF1" pod.
    ...
    # Task 4c: Find the memory request for the "AMF" pod.
    ...
    # Task 4d: Measure the CPU usage of the "UPF1" pod.
    ...
    # Task 5: Calculate the memory usage percentage for Slice 1 (SNSSAI=1-000001).
    ...
    # query = ''  # Your query here (memory requests for SMF1)
    ...
    # query = ''  # Your query here (memory requests for UPF1)
    ...
    # query = ''  # Your query here (memory usage for UPF1)
